...
PROTOCOL="${PROTOCOL:-${PROJECT_ROOT}/UNIV_adaptor/configs/univ_prompt_budget_phase1.json}"
...
OUT_ROOT="${OUT_ROOT:-${PROJECT_ROOT}/outputs/univ_prompt_budget_phase1_pilot_v1}"
...
print_plan() {
  ...
  echo "UNIV prompt budget phase1 plan"
  echo "  base:   (not required for phase1)"
...
generate_parallel() {
  ...
  GENERATION_LOCK_DIR="${OUT_ROOT}/.phase1_generation.lock"
...
print("Prompt budget phase1 protocol, runtime imports, and CUDA passed")
PY
    ;;
