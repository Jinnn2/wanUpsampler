...
case "${MODE}" in
  ...
  all)
    ...
    ;;
  *)
    echo "Usage: bash changing_resolution_distill/scripts/data/build_clean_480p720p_14b_cfgdistill_lmdb_1k.sh [prompts|generate|lmdb|all]" >&2
    exit 2
    ;;
esac

echo "14B CfgDistill clean-latent LMDB dataset path: ${LMDB_DIR}"
