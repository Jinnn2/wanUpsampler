...
CR_STAGE2_LMDB_DIR="${CR_STAGE2_LMDB_DIR:-${CR_DISTILL_CLEAN_LMDB_DIR}}"
...
export CR_DISTILL_DIT_CKPT="${CR_DISTILL_DIT_CKPT}"
...
export CR_DISTILL_CLEAN_LMDB_DIR="${CR_DISTILL_CLEAN_LMDB_DIR}"
