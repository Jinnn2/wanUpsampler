...
OUT_ROOT="${OUT_ROOT:-${PROJECT_ROOT}/outputs/router_b4_quality_aligned_comparison_lambda008}"
...
QUALITY_CURVE_ALPHA="${QUALITY_CURVE_ALPHA:-1.0}"
...
for train_seed in "${seed_array[@]}"; do
  ...
  args=(
    ...
    --quality_curve_alpha "${QUALITY_CURVE_ALPHA}"
...
echo "B4 versus B4-QA validation comparison: ${OUT_ROOT}/selection"
