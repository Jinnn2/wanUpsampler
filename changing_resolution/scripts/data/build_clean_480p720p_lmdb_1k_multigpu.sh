...
RAW_ROOT="${CR_RAW_VIDEO_DIR_1K:-${PROJECT_ROOT}/data/changing_resolution/raw_wan21_720p_1k}"
LMDB_ROOT="${CR_LMDB_DIR:-${PROJECT_ROOT}/data/changing_resolution/lmdb_480p720p_1k}"
...
echo "Multi-GPU clean-latent LMDB build"
...
echo "Merged LMDB ready: ${LMDB_ROOT}"
