...
"${PYTHON_BIN}" - "${ASSET_MANIFEST}" > "${CHECKPOINT_ROWS}" <<'PY'
import json
import sys
...
mkdir -p "${OUTPUT_ROOT}/source/review_code_data_package"
cp -a "${TOOLS_ROOT}/." "${OUTPUT_ROOT}/source/review_code_data_package/"
