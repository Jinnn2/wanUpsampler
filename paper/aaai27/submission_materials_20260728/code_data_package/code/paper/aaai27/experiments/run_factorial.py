...
def family_config(args: argparse.Namespace) -> dict[str, object]:
    if args.family == "wan50":
        return {
            ...
            "sample_shift": 8,
            "enable_cfg": True,
            "model_root": args.model_root or "/path/to/Wan-AI/Wan2.1-T2V-1.3B",
    ...
    return {
        ...
        "sample_shift": 5,
        "enable_cfg": False,
        "model_root": args.model_root or "/path/to/lightx2v/Wan2.1-T2V-14B-StepDistill-CfgDistill",
...
def inference_environment() -> dict[str, str]:
    ...
    lightx2v_repo = environment.get("LIGHTX2V_REPO", "/path/to/LightX2V")
    diffsynth_repo = environment.get("DIFFSYNTH_REPO", "/path/to/DiffSynth-Studio")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dit-ckpt", default="/path/to/lightx2v/Wan2.1-T2V-14B-StepDistill-CfgDistill/distill_model.pt")
