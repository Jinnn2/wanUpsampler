...
def main() -> None:
    ...
    lightx2v_repo = Path(os.environ.get("LIGHTX2V_REPO", "/path/to/LightX2V")).resolve()
    diffsynth_repo = Path(os.environ.get("DIFFSYNTH_REPO", "/path/to/DiffSynth-Studio")).resolve()
