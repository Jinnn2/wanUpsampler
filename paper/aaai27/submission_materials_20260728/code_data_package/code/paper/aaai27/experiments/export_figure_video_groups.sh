...
FINAL_EXPORT="/path/to/wanUpsampler/exports/aaai27_final_20260717"
INCREMENTAL_EXPORT="/path/to/wanUpsampler/exports/aaai27_closure_20260718_incremental"
...
Examples:
  ...
  bash export_figure_video_groups.sh \
    ...
    --output /path/to/talh_figure_videos.tar.gz
