...
def inference_environment() -> dict[str, str]:
    ...
    roots = [
        environment.get("LIGHTX2V_REPO", "/path/to/LightX2V"),
        environment.get("DIFFSYNTH_REPO", "/path/to/DiffSynth-Studio"),
        str(REPO_ROOT),
    ]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-root", default="/path/to/Wan-AI/Wan2.1-T2V-1.3B")
    parser.add_argument(
        "--stage2-checkpoint",
