...
CR_DISTILL_MODEL_ROOT="${CR_DISTILL_MODEL_ROOT:-/path/to/lightx2v/Wan2.1-T2V-14B-StepDistill-CfgDistill}"
...
OUT_DIR="${CR_DISTILL_LORA_LMDB_DIR:-${PROJECT_ROOT}/data/changing_resolution_distill/lmdb_last_step_skip_lora_14b_cfgdistill_5k_step3}"
...
echo "Cached x_pre_step3 last-step-skip LoRA LMDB build"
echo "  project          : ${PROJECT_ROOT}"
echo "  source_lmdb      : ${SOURCE_LMDB}"
echo "  out_dir          : ${OUT_DIR}"
echo "  train_step_index : ${TRAIN_STEP_INDEX} (0-based; 2 means x_pre_step3 input)"
...
python "${PROJECT_ROOT}/changing_resolution_distill/scripts/data/build_last_step_skip_lora_lmdb.py" "${args[@]}"
