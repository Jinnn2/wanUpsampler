...
for prompt in "${prompts[@]}"; do
  ...
  compare="${OUT_DIR}/compare/${sample_id}_stage2_chain_ab_compare.mp4"
  ...
  make_labeled_panel "${stage2_720}" "${p_stage2}" "stage2 720"
...
echo "Stage 2 chain A/B comparison videos ready: ${OUT_DIR}/compare"
