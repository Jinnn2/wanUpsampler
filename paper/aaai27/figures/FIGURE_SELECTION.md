...
| Fig. 2: TALH overview | `fig_talh_overview.png`, `fig_talh_overview.pdf` | ImageGen | `fig_talh_overview_imagegen.png`, `imagegen_prompt_talh_overview.md` |
...
- The PDFs for Figs. 2 and 3 are raster-backed wrappers created from the selected ImageGen PNGs; the PNGs are authoritative.
