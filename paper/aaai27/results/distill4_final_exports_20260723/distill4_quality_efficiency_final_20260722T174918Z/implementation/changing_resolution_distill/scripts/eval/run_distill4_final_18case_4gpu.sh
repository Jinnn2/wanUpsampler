...
DIFFSYNTH_REPO="${DIFFSYNTH_REPO:-/mnt/afs_2/houze/DiffSynth-Studio}"
REALESRGAN_REPO="${REALESRGAN_REPO:-/mnt/afs_2/houze/Real-ESRGAN}"

MODEL_ROOT="${DISTILL_MODEL_ROOT:-/mnt/afs_2/houze/lightx2v/Wan2.1-T2V-14B-StepDistill-CfgDistill}"
